local ScreenGui = Instance.new("GrengGUI")
local Frame = Instance.new("Frame")
local flin = Instance.new("flin")
local punc = Instance.new("punc")
local iy = Instance.new("iy")
local wal = Instance.new("wal")
local jum = Instance.new("jum")
local walkk = Instance.new("walkk")
local jumpp = Instance.new("jumpp")
local TextLabel = Instance.new("TextLabel")
local X = Instance.new("X")
